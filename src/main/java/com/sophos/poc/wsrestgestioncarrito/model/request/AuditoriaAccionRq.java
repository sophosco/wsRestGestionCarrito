...
public class AuditoriaAccionRq {
	  ...
	  public AuditoriaAccionRq fechaCreacion(OffsetDateTime fechaCreacion) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq idSesion(String idSesion) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq idUsuario(String idUsuario) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq tipoAccion(String tipoAccion) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq descripcionAccion(String descripcionAccion) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq moduloAplicacion(String moduloAplicacion) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq idProducto(String idProducto) {
	  ...
	  **/
	  ...
	  public AuditoriaAccionRq idCategoria(String idCategoria) {
	...
	@Override
	  public boolean equals(java.lang.Object o) {
	    ...
	    AuditoriaAccionRq accion = (AuditoriaAccionRq) o;
